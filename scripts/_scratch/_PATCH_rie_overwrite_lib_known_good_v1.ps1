...
# =========================
# rie_lib_v1.ps1 (KNOWN-GOOD MINIMAL) — overwrite
# =========================
...
[void]$L.Add("")
[void]$L.Add("function RIE-ReadUtf8NoBom([string]$Path){")
...
[void]$L.Add("}")
[void]$L.Add("")
[void]$L.Add("function RIE-WriteUtf8NoBomLf([string]$Path,[string]$Text){")
...
Parse-GateFile $Lib
Write-Host ("PATCH_RIE_LIB_KNOWN_GOOD_OK: " + $Lib) -ForegroundColor Green
