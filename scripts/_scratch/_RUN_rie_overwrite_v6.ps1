...
Write-Host "RIE_OVERWRITE_V6_START" -ForegroundColor Cyan

# 1) Schemas (NO here-strings; line arrays only)
$schemaSourceRecord = @(
'{'
...
Write-Host "RIE_OVERWRITE_V6_OK" -ForegroundColor Green
